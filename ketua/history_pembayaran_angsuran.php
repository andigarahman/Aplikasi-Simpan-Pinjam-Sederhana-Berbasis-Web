...
<head>
    ...
    <title>Riwayat Pembayaran Angsuran</title>
    <!-- plugins:css -->
...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Riwayat Pembayaran Angsuran</h4>
                    ...
                    <form class="forms-sample" method="get" action="">
                        ...
                        <div class="form-group">
                            ...
                            <select name="selected_status" id="selected_status">
                                ...
                                <option value="diterima" <?php echo (isset($_GET['selected_status']) && $_GET['selected_status'] === 'diterima') ? 'selected' : ''; ?>>Disetujui</option>
                    ...
                    <table class="table table-bordered" id="dataTable">
                        ...
                        if (isset($_GET['selected_month'])) {
                            ...
                            $sql = "SELECT * FROM pembayaran_angsuran WHERE MONTH(tanggal_pembayaran) = $selectedMonth AND YEAR(tanggal_pembayaran) = $selectedYear";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td><a href='../anggota/uploads/bukti_angsuran/" . $row['bukti_transfer'] . "' target='_blank'><img src='../anggota/uploads/bukti_angsuran/" . $row['bukti_transfer'] . "' alt='Bukti Transfer' style='max-width: 100px; max-height: 100px;'></a></td>";
                                    echo "<td>" . $row['tanggal_pembayaran'] . "</td>";
                                    echo "<td>" . $row['status'] . "</td>";
                                    echo "</tr>";
                                }
                            } else {
                                echo "<tr><td colspan='6'>Tidak ada data pembayaran angsuran.</td></tr>";
                            }
